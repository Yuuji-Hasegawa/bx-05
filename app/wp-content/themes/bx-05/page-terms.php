...
<div class="o-container o-container:underPage">
    <div class="c-inner-wrap u-pt-l u-mb-l">
        <p>
            本利用規約（以下「本規約」と言います。）には、本サイトの利用条件及び当社とユーザーの皆様との間の権利義務関係が定められています。本サイトの利用に際しては、本規約の全文をお読みいただいたうえで、本規約に同意いただく必要があります。
        </p>
        <dl>
            <dt class="c-term__title">第1条（適用）</dt>
            ...
            <dt class="c-term__title">第2条（定義）</dt>
            <dd class="c-term__content">
                ...
                <ol class="c-sub-section">
                    ...
                    <li class="c-sub-section__item">「当社」とは、<?php echo get_vars('company', 'name');?>を意味します。
                    </li>
                    <li class="c-sub-section__item">
                    ...
                    <li class="c-sub-section__item">
                        「ユーザー」とは、本サイトの利用者として情報の閲覧を行う個人または法人を意味します。
                    </li>
                    <li class="c-sub-section__item">
            ...
            <dt class="c-term__title">第3条（サイトの利用）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
                        本サイトの利用を希望する者（以下「閲覧希望者」といいます。）は、本規約を遵守することに同意することにより、当社に対し、本サイトを利用することができます。
                    </li>
                    <li class="c-section__item">
                        本サイト訪問時、または当社からの通知を確認した時に、本規約の同意が成立したとみなし、ユーザーは本サイトを本規約に従い利用することができるようになります。
                    </li>
                    <li class="c-section__item">
                        当社は、閲覧希望者が、以下の各号のいずれかの事由に該当する場合は、本サイトの利用または閲覧を拒否することがあり、またその理由について一切開示義務を負いません。
                        <ol class="c-sub-section">
                            <li class="c-sub-section__item">
                            ...
                            <li class="c-sub-section__item">第10条に定める措置を受けたことがある場合</li>
                            <li class="c-sub-section__item">その他、登録を適当でないと当社が判断した場合</li>
                        </ol>
                    </li>
                </ol>
            </dd>
            <dt class="c-term__title">第4条（禁止事項）</dt>
            <dd class="c-term__content">
                ユーザーは、本サイトの利用にあたり、以下の各号のいずれかに該当する行為または該当すると当社が判断する行為をしてはなりません。
                <ol class="c-sub-section">
                    <li class="c-sub-section__item">法令に違反する行為または犯罪行為に関連する行為</li>
                    <li class="c-sub-section__item">
                        当社、本サイトの他の利用者またはその他の第三者に対する詐欺または脅迫行為
                    </li>
                    <li class="c-sub-section__item">公序良俗に反する行為</li>
                    <li class="c-sub-section__item">
                    ...
                    <li class="c-sub-section__item">本サイトのネットワークまたはシステム等に過度な負荷をかける行為</li>
                    <li class="c-sub-section__item">
                        当社が提供するソフトウェアその他のシステムに対するリバースエンジニアリングその他の解析行為
                    </li>
                    <li class="c-sub-section__item">本サイトの運営を妨害するおそれのある行為</li>
                    <li class="c-sub-section__item">当社のネットワークまたはシステム等への不正アクセス</li>
                    <li class="c-sub-section__item">第三者に成りすます行為</li>
                    <li class="c-sub-section__item">
                        当社が事前に許諾しない本サイト上での宣伝、広告、勧誘、または営業行為
                    </li>
                    <li class="c-sub-section__item">本サイトの他の利用者の情報の収集</li>
                    <li class="c-sub-section__item">
                    ...
                    <li class="c-sub-section__item">
                        ...
                        <a href="<?php echo home_url('/terms');?>"
                            class="c-link c-link:inline"><?php echo home_url('/terms');?></a>
                        )に抵触する行為
                    </li>
                    <li class="c-sub-section__item">反社会的勢力等への利益供与</li>
                    <li class="c-sub-section__item">面識のない異性との出会いを目的とした行為</li>
                    <li class="c-sub-section__item">前各号の行為を直接または間接に惹起し、または容易にする行為</li>
                    <li class="c-sub-section__item">前各号の行為を試みること</li>
                    <li class="c-sub-section__item">その他、当社が不適切と判断する行為</li>
                </ol>
            </dd>
            <dt class="c-term__title">第5条（本サイトの停止等）</dt>
            <dd class="c-term__content">
                ...
                <ol class="c-sub-section">
                    ...
                    <li class="c-sub-section__item">その他、当社が停止または中断を必要と判断した場合</li>
                </ol>
            </dd>
            <dt class="c-term__title">第6条（権利帰属）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
            ...
            <dt class="c-term__title">第7条（利用停止等）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
                        当社は、ユーザーが、以下の各号のいずれかの事由に該当する場合は、事前に通知または催告することなく、当該利用者について本サイトの利用を一時的に停止し、またはユーザーとしての利用を停止することができます。
                        <ol class="c-sub-section">
                            <li class="c-sub-section__item">本規約のいずれかの条項に違反した場合</li>
                            <li class="c-sub-section__item">第3条第3項各号に該当する場合</li>
                            <li class="c-sub-section__item">
                                その他、当社が本サイトの利用またはユーザーとしての利用の継続を適当でないと判断した場合
                            </li>
                        </ol>
                    </li>
                </ol>
            </dd>
            <dt class="c-term__title">第8条（本サイトの内容の変更、終了）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
                    ...
                    <li class="c-section__item">
                        当社が本サイトの提供を終了する場合、当社はユーザーに事前に通知するものとします。
                    </li>
                </ol>
            </dd>
            <dt class="c-term__title">第9条（保証の否認及び免責）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
            ...
            <dt class="c-term__title">第10条（利用者情報の取扱い）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
                        ...
                        <a class="c-link c-link:inline"
                            ...
                            <?php echo home_url('/privacy-policy');?>
                        </a>
            ...
            <dt class="c-term__title">第11条（本規約等の変更）</dt>
            <dd class="c-term__content">
            ...
            <dt class="c-term__title">第12条（連絡／通知）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
            ...
            <dt class="c-term__title">第13条（サイト利用契約上の地位の譲渡等）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">
                    ...
                    <li class="c-section__item">
                        当社は本サイトにかかる事業を他社に譲渡した場合には、当該事業譲渡に伴い利用契約上の地位、本規約に基づく権利及び義務並びにユーザーの登録事項その他の顧客情報を当該事業譲渡の譲受人に譲渡することができるものとし、ユーザーは、かかる譲渡につき本項において予め同意したものとします。なお、本項に定める事業譲渡には、通常の事業譲渡のみならず、会社分割その他事業が移転するあらゆる場合を含むものとします。
                    </li>
                </ol>
            </dd>
            <dt class="c-term__title">第14条（分離可能性）</dt>
            <dd class="c-term__content">
                本規約のいずれかの条項またはその一部が、消費者契約法その他の法令等により無効または執行不能と判断された場合であっても、本規約の残りの規定及び一部が無効または執行不能と判断された規定の残りの部分は、継続して完全に効力を有するものとします。
            </dd>
            <dt class="c-term__title">第15条（準拠法及び管轄裁判所）</dt>
            <dd class="c-term__content">
                <ol class="c-section">
                    <li class="c-section__item">本規約及びサイト利用契約の準拠法は日本法とします。</li>
                    <li class="c-section__item">
