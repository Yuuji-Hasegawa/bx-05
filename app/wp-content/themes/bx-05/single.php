    ...
    <div class="c-inner-wrap">
        <header class="o-grid o-grid:headAuthor">
            ...
            <div class="o-stack o-stack:xxs">
                <a class="c-link" href="#authorInfo"><?php echo get_vars('author', 'name');?></a>
        ...
        <footer id="authorInfo" class="c-author-box">
            <div class="o-switcher o-switcher:author">
                ...
                <dl class="o-stack o-stack:xs">
                    <dt class="c-author-name">
                        <?php echo get_vars('author', 'name');?>
                    </dt>
                    <dd>
                        <?php echo get_vars('author', 'desc');?>
                        <div class="o-cluster o-cluster:sns">
                            <a href="<?php echo get_vars('author', 'fb');?>"
                                class="c-link c-link:sns" target="_blank" rel="noopener">
                            ...
                            <a href="<?php echo get_vars('author', 'tw');?>"
                                class="c-link c-link:sns" target="_blank" rel="noopener">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                    <path
                            ...
                            <a href="<?php echo get_vars('author', 'instagram');?>"
                                class="c-link c-link:sns" target="_blank" rel="noopener">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                    <path
                            ...
                            <a href="<?php echo get_vars('author', 'url');?>"
                                class="c-link c-link:sns" target="_blank" rel="noopener">
